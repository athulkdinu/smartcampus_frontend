...
import { Calendar, Clock, MapPin, FileText, Download, CheckCircle2 } from 'lucide-react'
    ...
    <MainLayout>
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-2">Exam Center</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { label: 'Upcoming Exams', value: exams.length, color: 'from-blue-500 to-blue-600' },
            { label: 'Completed', value: 0, color: 'from-green-500 to-green-600' },
            { label: 'Hall Tickets', value: exams.length, color: 'from-purple-500 to-purple-600' }
          ].map((stat, idx) => (
            <motion.div
              key={idx}
              initial={{ opacity: 0, y: 20 }}
